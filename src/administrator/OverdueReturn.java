...
public class OverdueReturn extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        overdueTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Borrow ID", "BooK ID", "Book Name", "User ID", "Issue Date", "Due Date", "Status"
            }
        ) {
    ...
    public void tableView() {
        over.getOverdueTableValue(overdueTable, "");
    ...
    private void overdueTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_overdueTableMouseClicked
        ...
        userIdField.setText(model.getValueAt(rowIndex, 3).toString());
        issueDateField.setText(model.getValueAt(rowIndex, 4).toString());
        dueDateField.setText(model.getValueAt(rowIndex, 5).toString());
        background();
    }//GEN-LAST:event_overdueTableMouseClicked

    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        overdueTable.setModel(new DefaultTableModel(null, new Object[]{"Borrow ID", "Book ID", "Book Name", "User ID", "Issue Date", "Due Date", "Status"}));
        over.getOverdueTableValue(overdueTable, searchField.getText());
