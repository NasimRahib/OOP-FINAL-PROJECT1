...
public class ReturnBook extends javax.swing.JPanel {
    ...
    public void tableView() {
        ret.getBorrowTableValue(borrowTable, "");
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        borrowTable.setModel(new DefaultTableModel(null, new Object[]{"Borrow ID", "Book ID", "Book Name", "User ID", "Issue Date", "Due Date", "Status"}));
        ret.getBorrowTableValue(borrowTable, searchField.getText());
