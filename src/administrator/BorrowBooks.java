...
public class BorrowBooks extends javax.swing.JPanel {
    ...
    public BorrowBooks() {
        ...
        tableView();
        defaultBackground();
        issueDateField.setText(df.format(date));
    ...
    public boolean isEmpty() {
        ...
        if (dueDateField.getDate() == null) {
            JOptionPane.showMessageDialog(null, "Due date is missing", "Warning", 2);
            return false;
        }
        if (dueDateField.getDate().compareTo(new Date()) < 0) {
    ...
    private void initComponents() {
        ...
        dueDateField.setPreferredSize(new java.awt.Dimension(60, 22));
    ...
    private void btnBorrowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrowActionPerformed
        if (isEmpty()) {
            ...
            String dueDate = df.format(dueDateField.getDate());
            String status = "Borrowing";
            if (borrow.isUserIdNotExist(userId)) {
    ...
    private void userIdFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_userIdFieldKeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }
    }//GEN-LAST:event_userIdFieldKeyTyped
